...
manipulate HiPERCAM and related data. The first will be of interest to anyone
using HiPERCAM; the second to those who want to code their own scripts.  This
