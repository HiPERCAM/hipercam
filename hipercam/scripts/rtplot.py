...
def rtplot(args=None):
    ...
    Arguments::
        ...
        source  : (string) [hidden]
           ...
           Data source, five options: 'hs' = HiPERCAM server; 'hl' = local
           HiPERCAM file; 'us' = ULTRACAM server; 'ul' = local ULTRACAM file;
           'hf' = list of HiPERCAM hcm FITS-format files, as generated by
           e.g. 'grab' or possibly imported from other data.
